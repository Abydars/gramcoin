        ...
        <div class="col-md-3">
            <div class="panel widget">
                ...
                <div class="panel-body bg-pink-custom text-white">
                    <div class="row">
                        <div class="col-lg-12 col-sm-12"><h4 class="m0">{{ number_format($user->spend, 10) }} BTC</h4>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-3">
            <div class="panel widget">
                ...
                <div class="panel-body bg-red-custom text-white">
                    <div class="row">
                        <div class="col-lg-6 col-sm-12"><h4 class="m0">{{ $user_status[$user->activated] }}</h4></div>
